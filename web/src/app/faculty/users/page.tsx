...
const ROLE_COLORS: Record<string, string> = {
  JAS_Developer: "bg-blue-950/30 text-blue-400",
  "JAS-Staff": "bg-amber-950/30 text-amber-400",
  "JAS-Faculty": "bg-purple-950/30 text-purple-400",
};
    ...
    <div className="max-w-7xl">
      <div className="mb-6">
        ...
        <p className="text-sm text-zinc-500">
          Manage platform users and role assignments &mdash; {total} total users
        </p>
      </div>
                ...
                {users.map((u) => {
                  ...
                  return (
                    <tr key={u.id} className="hover:bg-zinc-800/30 transition-colors">
                      ...
                      <td className="px-4 py-2.5 text-right font-mono text-xs font-semibold text-zinc-200">
                        {u.project_count}
                      </td>
